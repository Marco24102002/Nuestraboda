...
$('#btn-show-map').click(function () {
    $('#map-canvas').toggleClass('toggle-map-content');
});
...
*/
    ...
    $('#rsvp-form').on('submit', function (e) {
        ...
        $('#alert-wrapper').html(alert_markup('info', '<strong>Sólo un momento!</strong> Estamos verificando tus detalles.'));
            ...
            $.post('https://script.google.com/macros/s/AKfycbwjfQbxz6iaftIAr5tJUdnfNIcuLBLwvjBijQ77HOaU3O_wfKy4wpCSlQMIGHUNCxfVxA/exec', data)
...
//                 $('#alert-wrapper').html(''); // Limpia el mensaje
//                 $('#rsvp-modal').modal('show'); // Muestra modal de éxito
//             })
//             .fail(function (error) {
//                 console.log(error);
//                 $('#alert-wrapper').html(
